...
<html class="no-js" lang="zxx">
 ...
 try{        
	 ...
	 out.println("<tr>");
	 out.println("<th>"+"ID"+"</th>"+"<th>"+"TITLE"+"</th>"+"<th>"+"DESCRIPTION"+"</th>"+"<th>"+"DUEDATE"+"</th>"+"<th>"+"STATUS"+"</th>"+"<th>"+"DATE & TIME"+"</th>"+"<th>"+"STUDENT EMAIL"+"</th>");
	 out.println("</tr>");
	 ...
	 while(rs.next()){
		 ...
		 out.println("<tr>");
		 out.println("<td>"+rs.getInt(1)+"</td>"+"<td>"+rs.getString(2)+"</td>"+"<td>"+rs.getString(3)+"</td>"+"<td>"+rs.getString(4)+"</td>"+"<td>"+rs.getString(5)+"</td>"+"<td>"+rs.getString(6)+"</td>"+"<td>"+rs.getString(8)+"</td>");
