...
<section class="contact-section">
         ...
         PreparedStatement pss=con.prepareStatement("select * from prc where prcid=?");
         pss.setInt(1,pcid);
          rs=pss.executeQuery();
          while(rs.next()){
        	  %>
        	  <div class="col-lg-6">
                        <form class="form-contact contact_form" action="hodprcupdatedata.jsp" method="post" >
                            <div class="row">
                            <div class="col-12">
                                    <div class="form-group">
                                    <label>PCR ID:</label>
                                        <input type="number"   class="form-control w-100" name="pcrid" value="<%=pcid %>" readonly onfocus="this.placeholder = 'Enter   Title'" onblur="this.placeholder = 'Enter  Title '" placeholder=" Enter  Title "  required/>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                    <label>Title:</label>
                                        <input type="text"   class="form-control w-100" name="title" value="<%=rs.getString(2) %>"  onfocus="this.placeholder = 'Enter   Title'" onblur="this.placeholder = 'Enter  Title '" placeholder=" Enter  Title "  required/>
                                    </div>
                                </div>
                                 <div class="col-12">
                                    <div class="form-group">
                                    <label>Description:</label>
                                        <textarea class="form-control" name="desc" onfocus="this.placeholder = 'Enter Description'" onblur="this.placeholder = 'Enter Description '" placeholder="Enter Description  " required ><%=rs.getString(3) %></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                    <label>Date Of PRC:</label>
                                        <input type="date" id="ddate" class="form-control w-100" name="dateprc" value="<%=rs.getDate(4) %>" min="<%=LocalDate.now() %>" onfocus="this.placeholder = 'Enter   Title'" onblur="this.placeholder = 'Enter  Title '" placeholder=" Enter  Title " required/>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                   	<label>DueDate:</label>
                                        <input type="date" class="form-control" name="ddate"id="ddate" min="<%=LocalDate.now() %>"  value="<%=rs.getString(5) %>" required />
                                    </div>
                                </div>
                                  <div class="col-12">
                                    <div class="form-group">
                                   	...
                                   	<option value="<%=rs.getString(6)%>,<%=rs.getString(7)%>"><%=rs.getString(6) %></option>
                                   		...
                                   		<%try{
                                   			...
                                   			while(rss.next()){
                                   				count++;
                                   				%>
                                   				<option value="<%=rss.getString(2)%>,<%=rss.getString(3)%>"><%=rss.getString(2) %></option>
                                   				<% 
                                   			}if(count==0){
                                   				%>
