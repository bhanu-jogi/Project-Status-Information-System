...
<html class="no-js" lang="zxx">
   ...
   <div class="slider-area slider-height" style="height:550px"data-background="assets/img/hero/im.jpeg">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 col-lg-6">
                        <div class="support-location-img mb-50">
                            <img src="guideproimg.jsp?id=<%=rs.getInt(1) %>" style="width:570px;height:650px;"alt=""><!-- 570*720 -->
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="right-caption">
                            ...
                            <div class="section-tittle">
                                <span style="text-transform:uppercase"><%=rs.getString(5) %></span>
        ...
        <div class="detail-item ">
            ...
            <span><%=rs.getString(10) %>,<%=rs.getString(11) %>,<%=rs.getInt(12) %></span>
            
                            </div>
                            <div class="ml-5 m-5">
                            <a class="genric-btn primary" href="guideprofileupdate.jsp?id=<%=rs.getInt(1)%>">Update</a><a class="genric-btn danger ml-2" onclick="return confirm('Do You Want To Deactivate?')" href="guideprofiledeactivate.jsp?id=<%=rs.getInt(1)%>">Deactivate</a>
                            </div>
                        </div>
                    </div>
                </div>
