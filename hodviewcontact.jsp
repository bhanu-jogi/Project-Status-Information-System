                ...
                <div class="single-slider">
                    <div class="slider-cap-wrapper">
                        <div class="col-md-12">
                           ...
                           <h1  style="margin-right:100px;color:white;text-align:center;font-weight:bold;margin-top:125px;text-transform:uppercase;" data-animation="fadeInRight" data-delay=".5s"> CONTACTS</h1>
