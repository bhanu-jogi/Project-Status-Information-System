...
<html class="no-js" lang="zxx">
   ...
   <!-- slider Area Start-->
    ...
    <div style=margin-left:3%>          
	 ...
	 ResultSet rs=st.executeQuery("select * from title where email='"+email+"' and status='"+stt+"'");
	 out.println("<table BORDER=1px height=100 px WIDTH=100 px >");
	 out.println("<tr>");
	 out.println("<th>"+"ID"+"</th>"+"<th>"+"TITLE"+"</th>"+"<th>"+"ABSTRACT"+"</th>"+"<th>"+"DOMAIN"+"</th>"+"<th>"+"SOFTWARE REQUIREMENT"+"</th>"+"<th>"+"HARDWARE REQUIREMENT"+"</th>"+"<th>"+"DATE & TIME"+"</th>"+"<th>"+"EMAIL"+"</th>"+"<th>"+"STATUS"+"</th>"+"<th>"+"VIEWTASK"+"</th>");
	 out.println("<tr>");
	 ...
	 while(rs.next()){
		 ...
		 out.println("<td>"+"<h6><a class='btn btn-primary' href='viewtaskst.jsp?email="+rs.getString(9)+"'>View Task</a></h6></td>");
