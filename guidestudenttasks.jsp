...
<div class="slider-area slider-height" style="height:550px"data-background="assets/img/hero/im.jpeg">
            ...
            <section class="m-5">
            	<div class="container">
            					 ...
            					 try{
            						 ...
            						 while(rs.next()){
            							 ...
            							 if(status.equalsIgnoreCase("Completed")){
            								 %>
            								 <td><a class="genric-btn primary circle" href="guidestudenttaskdown.jsp?id=<%=rs.getInt(1)%>">Download</a></td>
            								 <%
            							 }else{
            								 %>
            								 <td></td>
            		...
            		<a class="genric-btn warning circle  ml-3" href="guideaddstudenttask.jsp?id=<%=spid%>">+Add Task</a>
            	</div>
            </section>
