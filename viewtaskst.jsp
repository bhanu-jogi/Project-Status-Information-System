...
<html class="no-js" lang="zxx">
 ...
 try{        
	...
	//System.out.println("st email="+mm);
	String gemail=null;
	  
	Statement st1=conn.createStatement();
	 ResultSet rs1=st1.executeQuery("select * from assign where stemail='"+email+"'");
	 out.println("<table border=1px width=80% >");
	 out.println("<tr>");
	 out.println("<th>"+"ID"+"</th>"+"<th>"+"TITLE"+"</th>"+"<th>"+"DESCRIPTION"+"</th>"+"<th>"+"DUEDATE"+"</th>"+"<th>"+"STATUS"+"</th>"+"<th>"+"DATE & TIME"+"</th>"+"<th>"+"UPDATE TASK"+"</th>");
	 out.println("</tr>");
	 while(rs1.next()){
		 gemail=rs1.getString(4);
	 
		 //System.out.println("gu email="+gemail);
	  
	  
	  
	 Statement st=conn.createStatement();
	 ResultSet rs=st.executeQuery("select * from task where email='"+gemail+"'");
	 ...
	 while(rs.next()){
		 ...
		 out.println("<td>"+"<h6><a class='btn btn-Red' href='updatetask.jsp?id="+rs.getInt(1)+"'>UpdateTask</a></h6>"+"</td>");
