            ...
            <section class="m-5 p-5">
                ...
                <div class="container">
                    <div class="slider-cap-wrapper">
                        ...
                        <form class="form-contact contact_form" action="studentuploadprcsubmissionsdata.jsp" method="post" enctype="multipart/form-data" >
                            <div class="col-8">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control " readonly name="prcid" required type="number" value="<%=prcid %>" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Email Address'" placeholder="Enter Email Address">
                                    </div>
